...
/// Print SHAKE256 hash value of files.
#[derive(Parser)]
...
struct ShakeArgs {
    ...
    #[arg(short, long, value_name = "BITS", default_value_t = 512, value_parser = hashlib::hash_width_parser)]
    width: usize,
...
fn main() -> ExitCode {
    ...
    hashlib::foreach_file(&args.file, |filename, file| {
        let checksum = hashlib::sha3::shake256(file, args.width);
